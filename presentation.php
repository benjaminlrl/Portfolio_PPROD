        ...
        <div class="container-presentation">
            <div class="presentation">
                ...
                <?php if($langue === "english"): ?>
                    ...
                    <p>I am <span class='important'>Benjamin Lorieul</span>, a <span class="important">work-study</span> employee for the <a href="#"><span class='important'>ministery of Army</span> / <span class='important'>DRHAT</span></a> in Tours.</p><br>
                    <p>I love coding projects, building applications or creating algorithms to solve various problems.</p><br>
                    <p>I am mainly focused on the creation of <span class='important'>websites</span> as well as <span class='important'>software solutions and applications</span>.</p><br>
                    <p>I learned mostly in self-taught with <span class='important'>HTML5, CSS and PHP</span> and I am now a student in the 1st year of <span class='important'>BTS SIO SLAM</span> in the city of Tours.</p><br>
                    <p>Alongside all of this, I practice <span class='important'>running</span> with the athletics club <span class='important'>FreeRunAthlé37</span> in Tours. With ambitions in this sport, I shape my life around it. With 8 to 13 hours of training per week and a work-study program for my BTS, <span class='important'>discipline is no longer an option</span>—it's a necessity to become the person I dream of being.</p>
                <?php endif ?>
            </div>
        </div>
